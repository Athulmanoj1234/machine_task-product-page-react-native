      ...
      >
        ...
        <View style={styles.banner} >
          ...
          <View style={{ paddingTop: 60, paddingLeft: 10, flexDirection: 'row', gap: 16, position: 'relative' }}>
            ...
            <TouchableOpacity style={{ height: 51, width: 250, backgroundColor: '#5f98f1', paddingVertical: 3, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderRadius: 10, position: 'absolute', top: 49, left: 100 }} onPress={() => setToCart(true)}><Text style={{ fontWeight: 'bold', color: 'white' }} >Add to Cart</Text></TouchableOpacity>
          </View>
        </View>
